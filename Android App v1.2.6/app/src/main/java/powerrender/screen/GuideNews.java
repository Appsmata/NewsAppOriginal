...
public class GuideNews extends AppCompatActivity{
    ...
    private String title_array_news[], description_array_news[];
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title_array_news = getResources().getStringArray(R.array.title_array);
        image = getResources().obtainTypedArray(R.array.image_array);
        description_array_news = getResources().getStringArray(R.array.description_array);
        addDots(0);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cur_dots < title_array_news.length){
    ...
    ViewPager.OnPageChangeListener viewPagerChange = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            addDots(position);
            if (position == title_array_news.length - 1){
                next.setText(getString(R.string.finish_guide_news));
                skip.setVisibility(View.GONE);
            }else{
                next.setText(getString(R.string.next_guide_news));
...
//        final String tokens = preferences.getString(getString(R.string.FCM_TOKEN), "");
    ...
    public void addDots(int dots){
        dots_image = new ImageView[title_array_news.length];
        linearLayout.removeAllViews();
        for (int i = 0; i<title_array_news.length; i++){
    ...
    public class GuideAdapterSetting extends PagerAdapter{
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View view = layoutInflater.inflate(R.layout.item_guide_news, null);
            ((TextView) view.findViewById(R.id.title)).setText(title_array_news[position]);
            ((ImageView) view.findViewById(R.id.image)).setImageResource(image.getResourceId(position, -1));
            ((TextView) view.findViewById(R.id.description)).setText(description_array_news[position]);
        ...
        @Override
        public int getCount() {
            return title_array_news.length;
        }
